...
(3, 'sherlock', 'sherlock@sa.com', 'its working'),
(4, 'sherlock', 'sherlock@sa.com', 'hello');
...
('Grilled Chicken Salad', 'Fresh salad with grilled chicken breast, mixed greens, cherry tomatoes, cucumbers, and balsamic vinaigrette dressing.', 12.99),
('Margherita Pizza', 'Classic pizza topped with tomato sauce, fresh mozzarella cheese, basil leaves, and a drizzle of olive oil.', 10.49),
('Chicken Burger', 'Juicy chicken patty served on a sesame seed bun with lettuce, tomato, onion, pickles, and a side of fries.', 9.99),
('Vegetable Stir-Fry', 'Assorted fresh vegetables stir-fried with tofu in a savory soy sauce, served with steamed rice.', 11.49),
('Spaghetti Carbonara', 'Spaghetti pasta tossed in a creamy sauce with bacon, Parmesan cheese, and black pepper.', 13.99);
...
CREATE TABLE IF NOT EXISTS `gym` (
  ...
  `name` VARCHAR(255) NOT NULL,
  `opening_hours` TEXT,
  `gym_trainner` VARCHAR(50)
);

INSERT INTO `gym` (`name`, `opening_hours`, `gym_trainner`) VALUES
('FitFlex Gym', 'Monday-Friday: 6:00 AM - 10:00 PM\nSaturday-Sunday: 8:00 AM - 8:00 PM', 'John Doe'),
('IronWorks Fitness', 'Monday-Saturday: 5:00 AM - 11:00 PM\nSunday: 7:00 AM - 9:00 PM', 'Jane Smith'),
('MuscleMax Gym', 'Monday-Friday: 7:00 AM - 9:00 PM\nSaturday: 9:00 AM - 7:00 PM\nSunday: Closed', 'Mike Johnson');
